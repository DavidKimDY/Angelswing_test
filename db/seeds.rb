...
project_1 = Project.create(title: 'Seoul Downtown', user_id: kim.id, project_type: "external", location: "Seoul", thumbnail: file, description: "best donwtown")
project_2 = Project.create(title: 'Daegu Downtown', user_id: lee.id, project_type: "external", location: "Deagu" ,thumbnail: file, description: "best donwtown")
